...
! function(n) { 
    ...
    n("#experience-timeline").each(function() { 
        ...
        $this.find('.vtimeline-point').each(function() {
            if (icon == 0) {
                n(this).prepend('<a href = "https://google.com" target="_blank"><div class="vtimeline-pic"><img class = "vtimeline-img-1" src = "/images/Blues.png"></div></a>'); 
                icon = icon + 1;
            } else if (icon == 1) {
                n(this).prepend('<a href = "https://google.com" target="_blank"><div class="vtimeline-pic"><img class = "vtimeline-img-2" src = "/images/Blues.png"></div></a>'); 
                icon = icon + 1;
            }
        });
    	//$this.find(".vtimeline-point").each(function() { 
